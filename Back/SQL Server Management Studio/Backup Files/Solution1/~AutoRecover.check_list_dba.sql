...
select * from espaco_disco


delete from analise_log
delete from espaco_disco
delete from hist_tabelas
delete from log_backup
delete from LOG_JOBS
delete from tamanho_arquivo
delete from tamanho_db


select * from analise_log
select * from espaco_disco
select * from hist_tabelas
select *  from log_backup
select * from LOG_JOBS
select * from tamanho_arquivo

select * from tamanho_db